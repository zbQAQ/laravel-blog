...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/index')}}">首页</a> &raquo; 修改文章分类
    </div>
    <!--面包屑导航 结束-->
	...
	<div class="result_wrap">
        ...
        <div class="result_content">
            <div class="short_wrap">
                <a href="{{url('admin/links')}}"><i class="fa fa-plus"></i>全部分类</a>
                <a href="{{url('admin/links/create')}}"><i class="fa fa-recycle"></i>添加分类</a>
            </div>
        </div>
    </div>
    <!--结果集标题与导航组件 结束-->
